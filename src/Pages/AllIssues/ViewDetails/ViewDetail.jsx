...
const ViewDetail = () => {
  ...
  return (
    <div className="mx-auto my-5 max-w-[1000px] rounded-2xl bg-white p-8 shadow-xl">
      ...
      {priority !== 'high' && (
        <Link to={`/payment/${_id}`}>
          <button className="mb-6 w-full rounded-lg bg-[#25408f] py-3 font-semibold text-white shadow transition hover:bg-[#1b2f6b]">
            Boost Issue
          </button>
        </Link>
      )}
      ...
      <div className="flex flex-col gap-4">
        ...
        <button
          ...
          className="w-full rounded-xl bg-red-500 py-3 font-semibold text-white shadow-md transition hover:bg-red-600"
        >
          Delete
        </button>
      </div>
